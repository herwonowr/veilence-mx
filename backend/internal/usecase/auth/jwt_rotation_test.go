...
func TestValidateAccessToken_PrimarySecret(t *testing.T) {
	svc := auth.NewService(nil, nil, nil, nil, nil, nil, nil, nil, nil, "primary-secret")
...
func TestValidateAccessToken_PreviousSecret_Accepted(t *testing.T) {
	svc := auth.NewService(nil, nil, nil, nil, nil, nil, nil, nil, nil,
		"new-secret",
		"old-secret-1",
	)
...
func TestValidateAccessToken_ExpiredToken_Rejected(t *testing.T) {
	svc := auth.NewService(nil, nil, nil, nil, nil, nil, nil, nil, nil, "test-secret")
...
func TestValidateAccessToken_NoPreviousSecrets(t *testing.T) {
	...
	svc := auth.NewService(nil, nil, nil, nil, nil, nil, nil, nil, nil, "only-secret")
