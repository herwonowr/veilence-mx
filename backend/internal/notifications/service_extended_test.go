...
func TestMarkAllRead_Success(t *testing.T) {
	...
	ch := createTestChannel(t, svc, 1, "email-ch", domain.NotificationChannelEmail, "{}")
...
func TestMarkAllRead_NoUnread(t *testing.T) {
	...
	ch := createTestChannel(t, svc, 1, "email-ch-2", domain.NotificationChannelEmail, "{}")
...
func TestMarkAllRead_OrgScoped(t *testing.T) {
	...
	ch1 := createTestChannel(t, svc, 1, "org1-ch", domain.NotificationChannelEmail, "{}")
	ch2 := createTestChannel(t, svc, 2, "org2-ch", domain.NotificationChannelEmail, "{}")
...
func TestDispatch_EmailChannel_SMTPNotConfigured(t *testing.T) {
	...
	ch := createTestChannel(t, svc, 1, "Email Ch", domain.NotificationChannelEmail, config)
...
func TestDispatch_EmailChannel_InvalidConfig(t *testing.T) {
	...
	ch := createTestChannel(t, svc, 1, "Bad Email", domain.NotificationChannelEmail, "not-json")
	createTestRule(t, svc, 1, ch.ID, "low")
...
func TestDispatch_EmailChannel_EmptyRecipients(t *testing.T) {
	...
	config := `{"recipients":""}`
	ch := createTestChannel(t, svc, 1, "Empty Recip", domain.NotificationChannelEmail, config)
	createTestRule(t, svc, 1, ch.ID, "low")
...
func TestDispatch_SlackChannel_Success(t *testing.T) {
	...
	ch := createTestChannel(t, svc, 1, "Slack Ch", domain.NotificationChannelSlack, config)
	createTestRule(t, svc, 1, ch.ID, "low")
...
func TestDispatch_SlackChannel_InvalidConfig(t *testing.T) {
	...
	ch := createTestChannel(t, svc, 1, "Bad Slack", domain.NotificationChannelSlack, "not-json")
	createTestRule(t, svc, 1, ch.ID, "low")
...
func TestDispatch_SlackChannel_EmptyURL(t *testing.T) {
	...
	ch := createTestChannel(t, svc, 1, "Empty Slack", domain.NotificationChannelSlack, `{"webhookUrl":""}`)
	createTestRule(t, svc, 1, ch.ID, "low")
...
func TestDispatch_SlackChannel_ServerError(t *testing.T) {
	...
	config := fmt.Sprintf(`{"webhookUrl":"%s"}`, server.URL)
	ch := createTestChannel(t, svc, 1, "Error Slack", domain.NotificationChannelSlack, config)
	createTestRule(t, svc, 1, ch.ID, "low")
...
func TestDispatch_SlackChannel_UnreachableURL(t *testing.T) {
	...
	ch := createTestChannel(t, svc, 1, "Dead Slack", domain.NotificationChannelSlack, config)
	createTestRule(t, svc, 1, ch.ID, "low")
